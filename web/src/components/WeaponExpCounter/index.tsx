...
import { useWeaponExpTarget } from "../../recoil/hooks/weaponExpTarget";
...
interface ExpCounterProps {
  resourceId: string;
}

const ExpCounter: React.FC<ExpCounterProps> = ({ resourceId }) => {
  ...
  const { weaponExpBatteries: target } = useWeaponExpTarget(resource.rarity);
